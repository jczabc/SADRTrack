...
from lib.models.hiptrack import pvt as pvt_module
import os
...
def build_backbone(cfg):
    ...
    ckpt_path = None
    backbone = Backbone(cfg.MODEL.BACKBONE.TYPE, train_backbone, return_interm_layers,#'LeViT_384' True False False 'default' 256 1 128 1 True 'FB'
