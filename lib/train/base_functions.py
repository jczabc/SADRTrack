...
def get_optimizer_scheduler(net, cfg):
    ...
    if train_cls:
        ...
        print('net.named_parameters() ' + str([name for name, _ in net.named_parameters()]))


        param_dicts = [
            {"params": [p for n, p in net.named_parameters() if "backbone" not in n and "levit" not in n and p.requires_grad]},
            #{
